...
def main() -> None:
    ...
    if not FORGE_DIR.exists():
        _run("git clone -b classic https://github.com/MightyCrimsonX/sd-webui-forge-classic.git", cwd=BASE_DIR)
    ...
    _run("uv pip install --python .venv clip gradio==3.41.2 ultralytics==8.3.216 insightface send2trash zip_unicode bs4 pysocks gdown aria2 pv lz4 --no-progress", cwd=FORGE_DIR)
